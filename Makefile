CC = nvcc
CFLAGS = -std=c++11 -m64 -arch=compute_35 -code=sm_35 --device-c --compiler-options=-Wall,-O3,-Wno-unused-function,-Wno-unused-local-typedef,-Wno-unused-private-field
