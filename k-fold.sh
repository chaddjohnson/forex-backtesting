...
for symbol in $@; do
    ...
    echo; echo "$symbol k-fold group 1 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 1 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 2 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 2 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 3 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 3 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 4 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 4 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 5 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 5 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 6 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 6 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 7 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 7 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 8 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 8 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 9 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 9 --optimizer reversals --investment 1000 --profitability 0.76
    ...
    echo; echo "$symbol k-fold group 10 testing..."; time ./bin/optimize --symbol $symbol --type testing --group 10 --optimizer reversals --investment 1000 --profitability 0.76
