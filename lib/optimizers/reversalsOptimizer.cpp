...
std::map<std::string, std::vector<std::map<std::string, boost::variant<std::string, double, bool>>>> ReversalsOptimizer::getConfigurationOptions() {
    std::map<std::string, std::vector<std::map<std::string, boost::variant<std::string, double, bool>>>> configurationOptions;

    // SMA 13
    std::vector<std::map<std::string, boost::variant<std::string, double, bool>>> sma13Options;
    sma13Options.push_back({{}});
    sma13Options.push_back({{"sma13", "sma13"}});
    configurationOptions["sma13"] = sma13Options;

    // EMA 50
    std::vector<std::map<std::string, boost::variant<std::string, double, bool>>> ema50Options;
    ema50Options.push_back({{}});
    ema50Options.push_back({{"ema50", "ema50"}});
    configurationOptions["ema50"] = ema50Options;

    // EMA 100
    std::vector<std::map<std::string, boost::variant<std::string, double, bool>>> ema100Options;
    ema100Options.push_back({{}});
    ema100Options.push_back({{"ema100", "ema100"}});
    configurationOptions["ema100"] = ema100Options;

    // EMA 200
    std::vector<std::map<std::string, boost::variant<std::string, double, bool>>> ema200Options;
    ema200Options.push_back({{}});
    ema200Options.push_back({{"ema200", "ema200"}});
    configurationOptions["ema200"] = ema200Options;

    // RSI
    std::vector<std::map<std::string, boost::variant<std::string, double, bool>>> rsiOptions;
    rsiOptions.push_back({{}});
    rsiOptions.push_back({{"rsi", "rsi2"}, {"overbought", 95.0}, {"oversold", 5.0}});
    rsiOptions.push_back({{"rsi", "rsi5"}, {"overbought", 80.0}, {"oversold", 20.0}});
    rsiOptions.push_back({{"rsi", "rsi7"}, {"overbought", 77.0}, {"oversold", 23.0}});
    rsiOptions.push_back({{"rsi", "rsi7"}, {"overbought", 80.0}, {"oversold", 20.0}});
    rsiOptions.push_back({{"rsi", "rsi9"}, {"overbought", 70.0}, {"oversold", 30.0}});
    rsiOptions.push_back({{"rsi", "rsi9"}, {"overbought", 77.0}, {"oversold", 23.0}});
    rsiOptions.push_back({{"rsi", "rsi14"}, {"overbought", 70.0}, {"oversold", 30.0}});
    configurationOptions["rsi"] = rsiOptions;

    // Stochastic Oscillator
    std::vector<std::map<std::string, boost::variant<std::string, double, bool>>> stochasticOptions;
    stochasticOptions.push_back({{}});
    stochasticOptions.push_back({{"K", "stochastic5K"}, {"D", "stochastic5D"}, {"overbought", 95.0}, {"oversold", 5.0}});
    configurationOptions["stochastic"] = stochasticOptions;

    // Polynomial Regression Channel
    std::vector<std::map<std::string, boost::variant<std::string, double, bool>>> prChannelOptions;
    prChannelOptions.push_back({{"upper", "prChannelUpper100_2_1.90"}, {"lower", "prChannelLower100_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_2_1.95"}, {"lower", "prChannelLower100_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_2_2.00"}, {"lower", "prChannelLower100_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_2_2.05"}, {"lower", "prChannelLower100_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_2_2.10"}, {"lower", "prChannelLower100_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_2_2.15"}, {"lower", "prChannelLower100_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_3_1.90"}, {"lower", "prChannelLower100_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_3_1.95"}, {"lower", "prChannelLower100_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_3_2.00"}, {"lower", "prChannelLower100_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_3_2.05"}, {"lower", "prChannelLower100_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_3_2.10"}, {"lower", "prChannelLower100_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_3_2.15"}, {"lower", "prChannelLower100_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_1.90"}, {"lower", "prChannelLower100_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_1.95"}, {"lower", "prChannelLower100_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.00"}, {"lower", "prChannelLower100_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.05"}, {"lower", "prChannelLower100_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.10"}, {"lower", "prChannelLower100_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.15"}, {"lower", "prChannelLower100_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.20"}, {"lower", "prChannelLower100_4_2.20"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.25"}, {"lower", "prChannelLower100_4_2.25"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.30"}, {"lower", "prChannelLower100_4_2.30"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.35"}, {"lower", "prChannelLower100_4_2.35"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_4_2.40"}, {"lower", "prChannelLower100_4_2.40"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper100_5_2.05"}, {"lower", "prChannelLower100_5_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_2_1.90"}, {"lower", "prChannelLower200_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_2_1.95"}, {"lower", "prChannelLower200_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_2_2.00"}, {"lower", "prChannelLower200_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_2_2.05"}, {"lower", "prChannelLower200_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_2_2.10"}, {"lower", "prChannelLower200_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_2_2.15"}, {"lower", "prChannelLower200_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_3_1.90"}, {"lower", "prChannelLower200_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_3_1.95"}, {"lower", "prChannelLower200_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_3_2.00"}, {"lower", "prChannelLower200_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_3_2.05"}, {"lower", "prChannelLower200_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_3_2.10"}, {"lower", "prChannelLower200_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_3_2.15"}, {"lower", "prChannelLower200_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_1.90"}, {"lower", "prChannelLower200_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_1.95"}, {"lower", "prChannelLower200_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.00"}, {"lower", "prChannelLower200_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.05"}, {"lower", "prChannelLower200_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.10"}, {"lower", "prChannelLower200_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.15"}, {"lower", "prChannelLower200_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.20"}, {"lower", "prChannelLower200_4_2.20"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.25"}, {"lower", "prChannelLower200_4_2.25"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.30"}, {"lower", "prChannelLower200_4_2.30"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.35"}, {"lower", "prChannelLower200_4_2.35"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_4_2.40"}, {"lower", "prChannelLower200_4_2.40"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper200_5_2.05"}, {"lower", "prChannelLower200_5_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_2_1.90"}, {"lower", "prChannelLower250_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_2_1.95"}, {"lower", "prChannelLower250_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_2_2.00"}, {"lower", "prChannelLower250_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_2_2.05"}, {"lower", "prChannelLower250_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_2_2.10"}, {"lower", "prChannelLower250_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_2_2.15"}, {"lower", "prChannelLower250_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_3_1.90"}, {"lower", "prChannelLower250_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_3_1.95"}, {"lower", "prChannelLower250_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_3_2.00"}, {"lower", "prChannelLower250_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_3_2.05"}, {"lower", "prChannelLower250_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_3_2.10"}, {"lower", "prChannelLower250_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_3_2.15"}, {"lower", "prChannelLower250_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_4_1.90"}, {"lower", "prChannelLower250_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_4_1.95"}, {"lower", "prChannelLower250_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_4_2.00"}, {"lower", "prChannelLower250_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_4_2.05"}, {"lower", "prChannelLower250_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_4_2.10"}, {"lower", "prChannelLower250_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_4_2.15"}, {"lower", "prChannelLower250_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper250_5_2.05"}, {"lower", "prChannelLower250_5_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_2_1.90"}, {"lower", "prChannelLower300_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_2_1.95"}, {"lower", "prChannelLower300_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_2_2.00"}, {"lower", "prChannelLower300_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_2_2.05"}, {"lower", "prChannelLower300_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_2_2.10"}, {"lower", "prChannelLower300_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_2_2.15"}, {"lower", "prChannelLower300_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_3_1.90"}, {"lower", "prChannelLower300_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_3_1.95"}, {"lower", "prChannelLower300_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_3_2.00"}, {"lower", "prChannelLower300_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_3_2.05"}, {"lower", "prChannelLower300_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_3_2.10"}, {"lower", "prChannelLower300_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_3_2.15"}, {"lower", "prChannelLower300_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_4_1.90"}, {"lower", "prChannelLower300_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_4_1.95"}, {"lower", "prChannelLower300_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_4_2.00"}, {"lower", "prChannelLower300_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_4_2.05"}, {"lower", "prChannelLower300_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_4_2.10"}, {"lower", "prChannelLower300_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_4_2.15"}, {"lower", "prChannelLower300_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper300_5_2.05"}, {"lower", "prChannelLower300_5_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_2_1.90"}, {"lower", "prChannelLower350_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_2_1.95"}, {"lower", "prChannelLower350_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_2_2.00"}, {"lower", "prChannelLower350_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_2_2.05"}, {"lower", "prChannelLower350_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_2_2.10"}, {"lower", "prChannelLower350_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_2_2.15"}, {"lower", "prChannelLower350_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_3_1.90"}, {"lower", "prChannelLower350_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_3_1.95"}, {"lower", "prChannelLower350_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_3_2.00"}, {"lower", "prChannelLower350_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_3_2.05"}, {"lower", "prChannelLower350_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_3_2.10"}, {"lower", "prChannelLower350_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_3_2.15"}, {"lower", "prChannelLower350_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_4_1.90"}, {"lower", "prChannelLower350_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_4_1.95"}, {"lower", "prChannelLower350_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_4_2.00"}, {"lower", "prChannelLower350_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_4_2.05"}, {"lower", "prChannelLower350_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_4_2.10"}, {"lower", "prChannelLower350_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_4_2.15"}, {"lower", "prChannelLower350_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper350_5_2.05"}, {"lower", "prChannelLower350_5_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_2_1.90"}, {"lower", "prChannelLower400_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_2_1.95"}, {"lower", "prChannelLower400_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_2_2.00"}, {"lower", "prChannelLower400_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_2_2.05"}, {"lower", "prChannelLower400_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_2_2.10"}, {"lower", "prChannelLower400_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_2_2.15"}, {"lower", "prChannelLower400_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_3_1.90"}, {"lower", "prChannelLower400_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_3_1.95"}, {"lower", "prChannelLower400_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_3_2.00"}, {"lower", "prChannelLower400_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_3_2.05"}, {"lower", "prChannelLower400_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_3_2.10"}, {"lower", "prChannelLower400_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_3_2.15"}, {"lower", "prChannelLower400_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_4_1.90"}, {"lower", "prChannelLower400_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_4_1.95"}, {"lower", "prChannelLower400_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_4_2.00"}, {"lower", "prChannelLower400_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_4_2.05"}, {"lower", "prChannelLower400_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_4_2.10"}, {"lower", "prChannelLower400_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_4_2.15"}, {"lower", "prChannelLower400_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper400_5_2.05"}, {"lower", "prChannelLower400_5_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_2_1.90"}, {"lower", "prChannelLower450_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_2_1.95"}, {"lower", "prChannelLower450_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_2_2.00"}, {"lower", "prChannelLower450_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_2_2.05"}, {"lower", "prChannelLower450_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_2_2.10"}, {"lower", "prChannelLower450_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_2_2.15"}, {"lower", "prChannelLower450_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_3_1.90"}, {"lower", "prChannelLower450_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_3_1.95"}, {"lower", "prChannelLower450_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_3_2.00"}, {"lower", "prChannelLower450_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_3_2.05"}, {"lower", "prChannelLower450_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_3_2.10"}, {"lower", "prChannelLower450_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_3_2.15"}, {"lower", "prChannelLower450_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_4_1.90"}, {"lower", "prChannelLower450_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_4_1.95"}, {"lower", "prChannelLower450_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_4_2.00"}, {"lower", "prChannelLower450_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_4_2.05"}, {"lower", "prChannelLower450_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_4_2.10"}, {"lower", "prChannelLower450_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_4_2.15"}, {"lower", "prChannelLower450_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper450_5_2.05"}, {"lower", "prChannelLower450_5_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_2_1.90"}, {"lower", "prChannelLower500_2_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_2_1.95"}, {"lower", "prChannelLower500_2_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_2_2.00"}, {"lower", "prChannelLower500_2_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_2_2.05"}, {"lower", "prChannelLower500_2_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_2_2.10"}, {"lower", "prChannelLower500_2_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_2_2.15"}, {"lower", "prChannelLower500_2_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_3_1.90"}, {"lower", "prChannelLower500_3_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_3_1.95"}, {"lower", "prChannelLower500_3_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_3_2.00"}, {"lower", "prChannelLower500_3_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_3_2.05"}, {"lower", "prChannelLower500_3_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_3_2.10"}, {"lower", "prChannelLower500_3_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_3_2.15"}, {"lower", "prChannelLower500_3_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_4_1.90"}, {"lower", "prChannelLower500_4_1.90"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_4_1.95"}, {"lower", "prChannelLower500_4_1.95"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_4_2.00"}, {"lower", "prChannelLower500_4_2.00"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_4_2.05"}, {"lower", "prChannelLower500_4_2.05"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_4_2.10"}, {"lower", "prChannelLower500_4_2.10"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_4_2.15"}, {"lower", "prChannelLower500_4_2.15"}});
    prChannelOptions.push_back({{"upper", "prChannelUpper500_5_2.05"}, {"lower", "prChannelLower500_5_2.05"}});
