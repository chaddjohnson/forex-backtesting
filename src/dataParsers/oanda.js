        ...
        .pipe(es.mapSync(function(line) {
            ...
            (function() {
                ...
                formattedData.push({
                    ...
                    timestamp: new Date(transactionData[2]),
                    volume: 0,
                    open: parseFloat(transactionData[3]),
                    high: parseFloat(transactionData[4]),
                    low: parseFloat(transactionData[5]),
                    close: parseFloat(transactionData[6])
                });
